    ...
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 100 }}>
      ...
      <View style={styles.body}>
        ...
        <View style={styles.aiBanner}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.aiTitle}>FinPilot AI Insight</Text>
          ...
          return (
            ...
            >
              <View style={styles.catHeader}>
                <View style={[styles.catIconBg, { backgroundColor: `${b.color}15` }]}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <View style={styles.spendSubRow}>
                    <Text style={[styles.spentVal, { color: over ? "#ef4444" : "#0f172a" }]}>
                      ₹{b.spent.toLocaleString("en-IN")}
                    </Text>
                    <Text style={styles.limitVal}>of ₹{b.limit.toLocaleString("en-IN")}</Text>
                  </View>
                </View>
                <Text
                  style={[
                ...
                <View style={styles.expandedDetail}>
                  <View style={styles.detailGrid}>
                    <View style={styles.detailCard}>
                      ...
                      <Text style={styles.detailVal}>₹{Math.round(b.spent / 11).toLocaleString("en-IN")}</Text>
                    </View>
                    <View style={styles.detailCard}>
                  ...
                  <View style={styles.actionRow}>
                    <Pressable style={styles.actionBtnLight}>
                      <Text style={styles.actionBtnLightText}>View Transactions</Text>
                    </Pressable>
                    <Pressable style={styles.actionBtnDark}>
...
const styles = StyleSheet.create({
  ...
  track: { height: 8, borderRadius: 4, backgroundColor: "#f1f5f9", marginVertical: 8 },
  fill: { height: "100%", borderRadius: 4 },
  progressMeta: { flexDirection: "row", justifyContent: "space-between" },
  metaText: { fontSize: 11, color: "rgba(255,255,255,0.5)" },
  body: { paddingHorizontal: 20, paddingTop: 20, gap: 12 },
  aiBanner: { flexDirection: "row", alignItems: "flex-start", gap: 12, padding: 12, borderRadius: 16, backgroundColor: "#f5f3ff", borderWidth: 1, borderColor: "#ede9fe" },
  sparkleIconBg: { width: 32, height: 32, borderRadius: 12, backgroundColor: "#7c3aed20", alignItems: "center", justifyContent: "center" },
  aiTitle: { fontSize: 12, fontWeight: "600", color: "#7c3aed", marginBottom: 2 },
  aiDesc: { fontSize: 12, lineHeight: 18, color: "#334155" },
  sectionTitle: { fontSize: 14, fontWeight: "600", color: "#64748b", marginVertical: 4 },
  catCard: { backgroundColor: "#ffffff", borderRadius: 20, padding: 16, borderWidth: 2, elevation: 1, marginBottom: 4 },
  ...
  limitVal: { fontSize: 12, color: "#94a3b8" },
  pctVal: { fontSize: 14, fontWeight: "bold" },
  expandedDetail: { marginTop: 16, paddingTop: 16, borderTopWidth: 1, borderTopColor: "#f1f5f9" },
  detailGrid: { flexDirection: "row", gap: 12, marginBottom: 12 },
  detailCard: { flex: 1, padding: 10, borderRadius: 12, backgroundColor: "#f8fafc" },
  detailLabel: { fontSize: 10, color: "#94a3b8" },
  detailVal: { fontSize: 14, fontWeight: "bold", color: "#0f172a", marginTop: 2 },
  actionRow: { flexDirection: "row", gap: 8 },
  actionBtnLight: { flex: 1, paddingVertical: 10, borderRadius: 12, backgroundColor: "#f1f5f9", alignItems: "center" },
  actionBtnLightText: { fontSize: 12, fontWeight: "600", color: "#64748b" },
  actionBtnDark: { flex: 1, paddingVertical: 10, borderRadius: 12, backgroundColor: "#0f172a", alignItems: "center" },
